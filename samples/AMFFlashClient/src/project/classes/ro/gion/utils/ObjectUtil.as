...
// ObjectUtil is a modified version of mx.utils.ObjectUtil, modified to work in
// projects that are AS3 only.  ObjectUtil will not work with IList objects or
// with any ObjectProxy objects.  I've only tested ObjectUtil.toString()
//
////////////////////////////////////////////////////////////////////////////////
...
public class ObjectUtil
{
    ...
    */
    ...
    public static function combine(dst:*, src:*):* {
        var e:Enumerator = Enumerator.create(dst);
        var i:*;
        while(i = e.next()) {
            dst[i] = src[i] != null ? src[i] : dst[i];
        }
        return dst;
    }
        ...
        switch (type)
        {
            ...
            case "object":
            {
                ...
                else
                {
                    ...
                    var isArray:Boolean = (value is Array) ? true : false;
                    var prop:*;
                    indent += 2;
