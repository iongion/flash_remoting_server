...
class Drupal_AMFPHP_Executive {
     ...
     */
    public function doMethodCall(&$bodyObj, &$object, $method, $args) 
    {
        try
        {
     ...
     */
    public function buildClass(&$bodyObj, $className)
    {
        global $amfphp;
     ...
     */
    public function deferredMethodCall(&$bodyObj, &$object, $method, $args)
    {
        try
        {
            $output = _flash_remoting_server_remoting_method_call($bodyObj->className, $method, $args);
            /*
            if($object === NULL)
            {
     ...
     */
    public function includeClass(&$bodyObj, $location)
    {
        $included = false;
        try
        {
